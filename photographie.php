...
<html lang="fr">
<head>
  <title>Maxime Randazzo | Photographie</title>
  <meta charset="utf-8">
...
<meta name="keywords" content="photographe, photographie, Ajaccio, Corte, Corse, photo, photos, expérience, images, mariage, baptême, bapteme, prestations, premium, portrait, paysage, évenements, event, Corsica, immobilier" >
...
<body oncontextmenu='return false;' onkeydown='return false;' onmousedown='return false;' id="body" >  
 ...
 <!-- Header -->
    ...
    <span></span>
    <ul id="menu">
      <li class="MenuTitle"><a  href="propos.html" title="Page à propos">À propos</a></li>
      <li class="MenuTitle"><a href="competences.html" title="Page compétences web">Mes compétences web</a></li>
    </ul>
  </div>
      </header>
...
foreach($fichiers as $file)
{
  ...
  echo "<a href='".$file."' data-ngthumb='".$file."' title='Photographie de Maxime Randazzo'></a>";
}
